...
st.set_page_config(page_title="Treehouse Deal Calculator v3.1", layout="wide")
...
st.caption("Formatted inputs/outputs + hover hints + quick definitions")
...
with st.sidebar:
    ...
    st.caption("Hover over any label or table header for a quick hint.")
